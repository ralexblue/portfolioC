...
export default class About extends Component{
  render(){
    return (
        ...
        more and more. I like how easier life has been by ordering online or whole taxi service using my phone.I also love to work as a team
        because recently I had to work on a team ,and I love being the team lead an assigning the necessary people for the right tasks.I personally desire to be a team lead one day
        ,and to accomplish that I know I need to handle people and work efficiently together.Throught that work as a team I know people can make great things.</p>
        </div>
        <div class="hobbies">
        <h2>Hobbies</h2>
